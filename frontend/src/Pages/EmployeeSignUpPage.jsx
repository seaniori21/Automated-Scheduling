        ...
        <div class="card bg-dark text-white" >
          <div class="card-body p-5 text-center">
            ...
            <div class="mb-md-5 mt-md-4 pb-5">
              ...
              <p class="text-white-50 mb-5">Employee Please Make your login and password!</p>

              <div className="d-grid gap-3 d-sm-flex justify-content-sm-center">
                    <div class="form-outline form-white mb-4">
                      <input type="firstname" id="typeFirstNameX" class="form-control form-control-lg" />
                      <label class="form-label" for="typeFirstName">First Name</label>
                    </div>
                    <div class="form-outline form-white mb-4">
                      <input type="lastname" id="typeLastName" class="form-control form-control-lg" />
